...
export class ClassesController {
    ...
    @ApiResponse({ status: 201, description: 'Classes created successfully', type: BaseResponseDto<Classes>, })
    @ApiResponse({ status: 400, description: 'Bad request - validation error', })
    @ApiResponse({ status: 401, description: 'Unauthorized - Authentication required', })
    async create(@CurrentUser() user: AuthUser, @Body() createClassesDto: CreateClassesDto) {
    ...
    @ApiResponse({ status: 401, description: 'Unauthorized - Authentication required', })
    async findAll(@Query() filters: FilterClassesDto) {
    ...
    @ApiResponse({ status: 200, description: 'Classes updated successfully', type: BaseResponseDto<Classes>, })
    @ApiResponse({ status: 404, description: 'Classes not found', })
    @ApiResponse({ status: 401, description: 'Unauthorized - Authentication required', })
    async update(@CurrentUser() user: AuthUser, @Param('id') id: string, @Body() updateClassesDto: UpdateClassesDto,) {
